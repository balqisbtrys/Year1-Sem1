...
The PC Assembly Lab Session provided hands-on experience in assembling and disassembling a PC. During the session, I learned to handle each components such as the power supply, RAM, hard disk, and cooling fan while following instructions properly. With guidance from the lab staff and teamwork with my groupmate, the PC was successfully reassembled and tested. A quiz at the end of the session helped reinforce my understanding of computer hardware.
