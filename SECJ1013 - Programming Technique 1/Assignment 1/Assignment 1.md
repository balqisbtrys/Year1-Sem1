...
* Apply branching/selection (if…else) in the flow chart
* Apply loop/repetition (repeat…until or do…while) in the flow chart
* Design at least one additional user-defined function with appropriate arguments
